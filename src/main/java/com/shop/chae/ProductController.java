...
public class ProductController {
	...
	public void getProductList(@ModelAttribute("rtnVal") SearchCriteria sCria, Model model) throws Exception{
/*		@ModelAttribute을 써서 HTTP 요청에 들어있는 속성값들을 Member 커맨드 객체에 자동적으로 바인딩 하게 된다. 
	...
	public void read(@RequestParam(value= "prodCd" ,required = false) String prodCd, Model model) throws Exception{
