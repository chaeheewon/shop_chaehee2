	...
	<div class="container bgwhite p-t-35 p-b-80">
		<div class="flex-w flex-sb">
			...
			<div class="w-size14 p-t-30 respon5">
				<!-- prodCd -->
				<input type="hidden"  name="prodCd"  id = "prodCd" value="${goods.prodCd}"/>
				
				<h4 class="product-detail-name m-text16 p-b-13">
					${goods.prodNm}
				</h4>

				<span class="m-text17 numComma">
					${goods.csmePrice} won
				</span>
					...
					<div class="flex-r-m flex-w p-t-10">
						<div class="w-size16 flex-m flex-w">
							<div class="flex-w bo5 of-hidden m-r-22 m-t-10 m-b-10">
								...
								<input class="size8 m-text18 t-center num-product" type="number"  name="cartStock"  id = "cartStock" value="1">
...
<!-- 								<button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
								...
								<button type="button" class="btn btn-outline-danger addCart" >
 									ADD TO CART
								</button>
							</div>
						</div>
							...
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								...
								<div class="block2-overlay trans-0-4">
									...
									<div class="block2-btn-addcart w-size1 trans-0-4">
										...
										<button type="button"  class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4 addCart" >
 											 Add to Cart
										</button>
									</div>
								</div>
